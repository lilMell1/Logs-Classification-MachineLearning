...
def main():
    ...
    for idx, log in enumerate(logs):
        ...
        prediction_output = classify_log(log, train=train_mode)  # ✅ fix
    ...
    evaluate_metrics(processed_logs, output_file_path=last_result_learning, summary_file_path=summery_of_results_learning)
